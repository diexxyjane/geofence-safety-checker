...
The system will detect sensitive locations like YMCA, schools, hospitals, religious organizations, and more.
""")

num_rows = 50

# Initialize session state for editable table
...
if st.button("Reset Table"):
    ...
    st.session_state['input_data'] = empty_df
    # Reassign editor variable to reflect changes
...
if st.button("Check Safety"):
    ...
    for _, row in input_df.iterrows():
        ...
        # Flexible state detection (2 uppercase letters near end)
